            ...
            var json = @"
{
  ...
  ""components"": { ""schemas"": {} }
        ...
        public void AndGivenSecurityHasBeenConfigured()
        {
        ...
        {
            _primaryJson.Contains("ApiKeyAuth").Should().BeTrue();
            _primaryJson.Contains(_configuration.SecurityKeyName).Should().BeTrue();
        }
    }
}